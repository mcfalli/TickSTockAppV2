...
class CreateProjectStructureDocumentation:
    ...
    def _scan_files(self):
        ...
        exclude_dirs = {
            ...
            'logs', 'data', 'node_modules', '__pycache__', '.pytest_cache',
            'dist', 'build', '*.egg-info'
        }
    ...
    def _identify_module_from_import(self, import_path: str) -> Optional[str]:
    ...
    def _analyze_testing_strategy(self) -> Dict:
        ...
        return {
            ...
            'test_categories': {
                ...
                'component_tests': [f for f in test_files if not 'trace' in f and 'test_' in f][:5]
            },
    ...
    def _determine_architectural_role(self, file_path: str) -> str:
        ...
        elif 'provider' in filename or 'adapter' in filename:
            return 'data_provider'
        elif 'detector' in filename or 'processor' in filename:
            return 'event_processor'
        elif 'publisher' in filename or 'websocket' in filename:
            return 'communication'
        elif 'model' in filename or 'event' in filename:
            return 'domain_model'
    ...
    def _determine_component_role(self, component_name: str) -> str:
        ...
        if 'service' in name_lower or 'manager' in name_lower:
            return 'orchestrator'
        elif 'provider' in name_lower or 'adapter' in name_lower:
            return 'data_provider'
        elif 'detector' in name_lower or 'processor' in name_lower:
            return 'event_processor'
        elif 'publisher' in name_lower or 'websocket' in name_lower:
            return 'communication'
        elif 'event' in name_lower or 'model' in name_lower:
            return 'domain_model'
        else:
            return 'support'
...
def main():
    ...
    # Print summary
    print(f"\n{'='*60}")
    print(f"📊 TickStock V2 Documentation Generation Complete")
    print(f"{'='*60}")
