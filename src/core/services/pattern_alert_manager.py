...
class PatternSubscription:
    ...
    symbols: Optional[Set[str]] = None  # If None, subscribe to all symbols
...
class UserAlertPreferences:
    ...
    quiet_hours_start: Optional[str] = None  # "22:00" format
    quiet_hours_end: Optional[str] = None    # "08:00" format
...
class PatternAlertManager:
    ...
    def __init__(self, redis_client: redis.Redis, tickstock_db: Optional[TickStockDatabase] = None):
    ...
    def get_pattern_performance(self, pattern: Optional[str] = None) -> List[Dict[str, Any]]:
