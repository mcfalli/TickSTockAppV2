...
try:
    from src.monitoring import SystemMonitor, DiagnosticCollector, MonitoringConfig, MetricsBuffer
except ImportError:
...
try:
    from src.monitoring.tracer import tracer, DebugTracer, TickerTrace
except ImportError:
...
class TestMonitoringOptimization(unittest.TestCase):
    ...
    def test_8_caching_behavior(self):
        ...
        if time2 > 0:
            ...
            print(f"✅ Cache speedup: >1000x (instant)")
