...
from backend.config.app_config import create_flask_app, initialize_flask_extensions, initialize_socketio
from backend.config.logging_config import get_domain_logger, LogDomain, get_session_id, configure_logging
from backend.data_sources.websocket.web_socket_manager import WebSocketManager
from backend.processing.engine.core_service import MarketDataService
from backend.processing.engine.event_detection_manager import EventDetectionManager

from backend.data_sources.data_provider_factory import DataProviderFactory
from backend.api.services.sms_manager import SMSManager
from backend.utils.monitoring.monitoring import system_monitor

#TRACE TRACING
from backend.utils.monitoring.tracer import tracer, TraceLevel, normalize_event_type, ensure_int
            ...
            if should_sync_analytics:
                ...
                if analytics_sync_result.get('success', False):
                    ...
                    if analytics_synced > 0:
                        ...
                        from database import MarketAnalytics
...
if __name__ == '__main__':
    ...
    from app_routes_auth import register_auth_routes
    from app_routes_main import register_main_routes  
    from app_routes_api import register_api_routes
    ...
    if config.get('TRACE_ENABLED', False):
        ...
        from backend.utils.monitoring.monitoring import system_monitor, SystemMonitor, MonitoringConfig
