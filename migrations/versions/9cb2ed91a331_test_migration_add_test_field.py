...
Revision ID: 9cb2ed91a331
Revises: d176423a036f
Create Date: 2025-05-26 11:46:27.869200
...
revision = '9cb2ed91a331'
down_revision = 'd176423a036f'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('users', schema=None) as batch_op:
        batch_op.add_column(sa.Column('test_migration_field', sa.String(length=50), nullable=True))
        batch_op.add_column(sa.Column('migration_test_complete', sa.Boolean(), nullable=True))
