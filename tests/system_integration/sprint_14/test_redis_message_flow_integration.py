...
from src.core.services.market_data_subscriber import MarketDataSubscriber, MarketEventType, MarketDataEvent
from src.infrastructure.redis.redis_connection_manager import RedisConnectionManager, RedisConnectionConfig
from src.core.services.redis_performance_monitor import RedisPerformanceMonitor
...
class MockRedisMessageConsumer:
    ...
    def _convert_to_websocket_format(self, message: Dict[str, Any]) -> Dict[str, Any]:
        ...
        elif message.get('type') == 'eod_completion':
            return {
...
class TestRedisConnectionResilience:
    ...
    def test_circuit_breaker_pattern(self, mock_redis_class, message_flow_metrics: MessageFlowMetrics):
        ...
        print(f"  Total Connection Attempts: 10")
...
class TestRedisMessageQueueManagement:
    ...
    def test_message_queue_overflow_handling(self, message_flow_metrics: MessageFlowMetrics):
        ...
        print(f"  Messages Generated: 1500")
