...
from app_forms import UpdateEmailForm, UpdatePhoneForm, VerifyPhoneForm
...
from backend.storage.database.model import User, db, Subscription, BillingInfo
...
def register_main_routes(app, extensions, cache_control, config):
    ...
    def account():
        ...
        if update_phone_form.submit_phone.data and update_phone_form.validate():
            ...
            from app_utils import validate_phone_number
            ...
            if action == 'cancel':
                ...
                try:
                    ...
                    if billing_info:
                        ...
                        # Refresh billing_info from database
