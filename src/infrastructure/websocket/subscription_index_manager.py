...
class SubscriptionIndexManager:
    ...
    def remove_subscription(self, user_id: str, subscription_type: str | None = None) -> bool:
        """
    ...
    def _get_index_dict(self, index_type: str) -> dict[str, IndexEntry] | None:
    ...
    def _check_compound_indexes(self, criteria: dict[str, Any]) -> set[str] | None:
