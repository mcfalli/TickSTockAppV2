...
from src.core.domain.events.tier_events import TierPatternEvent, MarketStateEvent, PatternTier, MarketRegime
...
class TestComplianceSummary:
    ...
    def test_generate_compliance_summary(self):
        ...
        print(f"\n{'='*60}")
        print(f"SPRINT 25 ARCHITECTURE COMPLIANCE SUMMARY")
        print(f"{'='*60}")
