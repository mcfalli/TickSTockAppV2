...
class PatternDiscoveryService:
    ...
    def __init__(self, app: Flask, config: dict[str, Any]):
        ...
        self.pattern_cache: RedisPatternCache | None = None
        self.tickstock_db: TickStockDatabase | None = None
        self.cache_control: CacheControl | None = None
...
_global_pattern_discovery_service: PatternDiscoveryService | None = None

def get_pattern_discovery_service() -> PatternDiscoveryService | None:
