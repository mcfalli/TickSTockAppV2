...
class UniversalWebSocketManager:
    ...
    def unsubscribe_user(self, user_id: str, subscription_type: str | None = None) -> bool:
        """
    ...
    def broadcast_event(self, event_type: str, event_data: dict[str, Any],
                       targeting_criteria: dict[str, Any] | None = None) -> int:
        """
        ...
        try:
            ...
            elif targeting_criteria.get('priority') == 'high' or targeting_criteria.get('confidence', 0) >= 0.9:
